...
CREATE TABLE plane (
    ...
    enemy BOOLEAN,   -- To store "Enemy"
    time_position DATETIME, -- To store "Time_position"
    geo_altitude INT, -- To store "Geo_altitude"
    velocity INT, -- To store "Velocity"
    true_track INT, -- To store "True_track"
    call_sign VARCHAR(255), -- To store "Call_sign"
    origin_country VARCHAR(255), -- To store "Origin_country"
    on_ground BOOLEAN, -- To store "On_ground"
